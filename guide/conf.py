# -*- coding: utf-8 -*-
#
# Xitrum Guide build configuration file, created by
...
if language == 'ja':
    authors = [u'押田　丈治', u'Ngoc Dao', u'Aleksander Guryanov', u'Phuc Le']
...
latex_documents = [
  ('index', 'xitrum.tex', u'Xitrum Scala Web Framework Guide',
   authors_string, 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '../img/whale.png'
