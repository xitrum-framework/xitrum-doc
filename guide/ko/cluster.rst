...
`Akka <http://akka.io/>`_와`Hazelcast <https://github.com/xitrum-framework/xitrum-hazelcast>`_
클러스터링 기능을 사용하여 캐시, 세션, SockJS세션 을 클러스터링 할 수 있습니다.
...
`Hazelcast 문서 <http://hazelcast.org/documentation/>`_를 참고하십시오.
