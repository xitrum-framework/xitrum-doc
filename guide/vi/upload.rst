...
Xem thêm :doc:`Chương Scopes </scopes>`.
...
Sử dụng các method của chúng để lấy tên tập tin, di chuyển tệp vào một thư mục v.v.

Các tập tin nhỏ (nhỏ hơn 16 KB) sẽ được lưu trong bộ nhớ. Các tệp lớn thường được lưu
...
để gửi tệp, hãy xem :doc:`Xitrum access log </log>`.
