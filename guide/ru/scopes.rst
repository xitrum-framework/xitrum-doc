...
другим типам, перекройте метод `convertTextParam <https://github.com/xitrum-framework/xitrum/blob/master/src/main/scala/xitrum/scope/request/ParamAccess.scala>`_.
