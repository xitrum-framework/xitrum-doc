...
С установленным его Scala плагин, просто откройте свой проект SBT,
Вам не нужно для создания файлов проекта, как с Eclipse.
...
* В первой выполните ``sbt/sbt fgRun``. Эта команда запустить программу и будет
